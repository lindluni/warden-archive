...
`
    ...
    async getOrgOwners(org) {
        ...
        const admins = this.octokit.paginate(this.octokit.orgs.listMembers, {
            org: org,
            role: 'admin',
            per_page: 100
        })
    ...
    async getTeams(owner, repo) {
        ...
        return await this.octokit.paginate(this.octokit.rest.repos.listTeams, {
            owner: owner,
            repo: repo,
            per_page: 100
        })
    ...
    async getTeamMembers(org, slug) {
        ...
        return await this.octokit.paginate(this.octokit.teams.listMembersInOrg, {
            org: org,
            team_slug: slug,
            role: 'all',
            per_page: 100
